...
public class CreateTaskCheckListFormTest {
    @BeanMock
    private ICreateTaskCheckListService m_mockSvc;
// TODO [lukacavic] add test cases

    @Before
    public void setup() {
        CreateTaskCheckListFormData answer = new CreateTaskCheckListFormData();
