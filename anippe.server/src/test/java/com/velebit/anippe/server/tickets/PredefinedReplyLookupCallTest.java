...
public class PredefinedReplyLookupCallTest {
// TODO [lukacavic] add test cases

    protected PredefinedReplyLookupCall createLookupCall() {
        return new PredefinedReplyLookupCall();
    }

    @Test
    public void testGetDataByAll() {
        PredefinedReplyLookupCall call = createLookupCall();
